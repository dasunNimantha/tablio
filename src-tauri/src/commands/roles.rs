...
pub async fn create_role(
    ...
    let driver = pool.get_driver(&request.connection_id).await.map_err(|e| e.to_string())?;
    driver.create_role(&request).await.map_err(|e| e.to_string())
}
...
pub async fn drop_role(
    ...
    let driver = pool.get_driver(&request.connection_id).await.map_err(|e| e.to_string())?;
    driver.drop_role(&request.name).await.map_err(|e| e.to_string())
}
